...
{ // This is called just once, at the start of V-REP
    ...
    simRegisterScriptCallbackFunction(strConCat(LUA_LOADUI_COMMAND,"@","LuaRemoteApiClient"),strConCat("number returnCode,table uiHandles=",LUA_LOADUI_COMMAND,"(number clientId,string uiPathAndName,number options,number operationMode)"),LUA_LOADUI_CALLBACK);
    ...
    simRegisterScriptCallbackFunction(strConCat(LUA_GETUIBUTTONPROPERTY_COMMAND,"@","LuaRemoteApiClient"),strConCat("number returnCode,number property=",LUA_GETUIBUTTONPROPERTY_COMMAND,"(number clientId,number uiHandle,number uiButtonId,number operationMode)"),LUA_GETUIBUTTONPROPERTY_CALLBACK);
    simRegisterScriptCallbackFunction(strConCat(LUA_GETUIEVENTBUTTON_COMMAND,"@","LuaRemoteApiClient"),strConCat("number returnCode,number uiEventButtonId,table_2 auxValues=",LUA_GETUIEVENTBUTTON_COMMAND,"(number clientId,number uiHandle,number operationMode)"),LUA_GETUIEVENTBUTTON_CALLBACK);
    simRegisterScriptCallbackFunction(strConCat(LUA_GETUIHANDLE_COMMAND,"@","LuaRemoteApiClient"),strConCat("number returnCode,number uiHandle=",LUA_GETUIHANDLE_COMMAND,"(number clientId,string uiName,number operationMode)"),LUA_GETUIHANDLE_CALLBACK);
    simRegisterScriptCallbackFunction(strConCat(LUA_GETUISLIDER_COMMAND,"@","LuaRemoteApiClient"),strConCat("number returnCode,number sliderPosition=",LUA_GETUISLIDER_COMMAND,"(number clientId,number uiHandle,number uiButtonId,number operationMode)"),LUA_GETUISLIDER_CALLBACK);
    ...
    simRegisterScriptCallbackFunction(strConCat(LUA_REMOVEUI_COMMAND,"@","LuaRemoteApiClient"),strConCat("number returnCode=",LUA_REMOVEUI_COMMAND,"(number clientId,number uiHandle,number operationMode)"),LUA_REMOVEUI_CALLBACK);
    ...
    simRegisterScriptCallbackFunction(strConCat(LUA_SETUIBUTTONLABEL_COMMAND,"@","LuaRemoteApiClient"),strConCat("number returnCode=",LUA_SETUIBUTTONLABEL_COMMAND,"(number clientId,number uiHandle,number uiButtonId,string upStateLabel,string downStateLabel,number operationMode)"),LUA_SETUIBUTTONLABEL_CALLBACK);
    simRegisterScriptCallbackFunction(strConCat(LUA_SETUIBUTTONPROPERTY_COMMAND,"@","LuaRemoteApiClient"),strConCat("number returnCode=",LUA_SETUIBUTTONPROPERTY_COMMAND,"(number clientId,number uiHandle,number uiButtonId,number property,number operationMode)"),LUA_SETUIBUTTONPROPERTY_CALLBACK);
    simRegisterScriptCallbackFunction(strConCat(LUA_SETUISLIDER_COMMAND,"@","LuaRemoteApiClient"),strConCat("number returnCode=",LUA_SETUISLIDER_COMMAND,"(number clientId,number uiHandle,number uiButtonId,number position,number operationMode)"),LUA_SETUISLIDER_CALLBACK);
